...
public class GoogleUtils {
    ...
    public String getToken(final String code) throws Exception {   //từ code lấy ra token
    ...
    public GooglePojo getUserInfo(final String accessToken) throws ClientProtocolException, IOException {   //từ token lấy ra được info
