...
public class HouseListTest {
    ...
    public void testCountHouse() {
        ...
        when(houseRepository.countHouse(min1, max1, min2, max2,statusid1,statusid2, houseName, type, service, countService))
                .thenReturn(12);

        // Calling the service method
        int result = houseService.countHouse(min1, max1, min2, max2,statusid1,statusid2, houseName, type, service, countService);


        // Asserting the result
        assertEquals(11, result);
        verify(houseRepository).countHouse(min1, max1, min2, max2,statusid1,statusid2, houseName, type, service, countService);
    }
    @Test
