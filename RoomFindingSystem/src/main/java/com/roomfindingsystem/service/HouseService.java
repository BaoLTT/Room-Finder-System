...
public interface HouseService {
    ...
    List<HouseTypeVo> findHouse(int min1, int max1, int min2, int max2,int status1,int status2,String houseName,List<Integer> type, List<Integer> service,int countService, int pageIndex,int pageSize);
