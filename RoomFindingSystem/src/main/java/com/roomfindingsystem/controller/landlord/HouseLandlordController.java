...
public class HouseLandlordController {
    ...
    @PostMapping("/save")
    public String saveHouse(@ModelAttribute(name = "house") HouseLandlordVo house, @RequestParam( value = "file") MultipartFile[] files,HttpServletRequest request) throws IOException {
    ...
    @PostMapping("/update")
    public String updateHouse(@ModelAttribute(name = "house") HouseLandlordVo house,@RequestParam( value = "file") MultipartFile[] files,@RequestParam(name = "service", required = false,defaultValue = "0") List<Integer> service, Model model, HttpSession httpSession,HttpServletRequest request) throws IOException {
